...
WITH new_users AS (
  ...
  WHERE event_date BETWEEN '2026-01-29' AND '2026-03-08'
    AND event_name = 'first_open'
  GROUP BY user_pseudo_id, user_id, ab_group
  HAVING ab_group IS NOT NULL
    AND install_date BETWEEN DATE '2026-01-30' AND DATE '2026-03-08'
),
...
max_raw AS (
  ...
  WHERE _TABLE_SUFFIX BETWEEN '20260130' AND '20260407'
