-- 查询目的：统计全量 request 的总 placement_cnt 分布，并新增 country 维度。
-- 输出字段：experiment_group, product, ad_format, country, placement_cnt, request_pv, denominator_request_pv, share
...
denominator_totals AS (
  ...
  GROUP BY experiment_group, product, ad_format, country
),
