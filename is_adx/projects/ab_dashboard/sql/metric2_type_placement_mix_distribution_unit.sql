-- 查询目的：固定总 placement_cnt 后，统计 bidding_placement_cnt + waterfall_placement_cnt 的组合分布，并新增 max_unit_id 维度。
-- 输出字段：experiment_group, product, ad_format, max_unit_id, placement_cnt, bidding_placement_cnt, waterfall_placement_cnt, request_pv, denominator_request_pv, share
