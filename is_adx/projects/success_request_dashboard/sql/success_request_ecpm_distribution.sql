...
GROUP BY product, ad_format, experiment_group, country, max_unit_id, cnt_type, cnt_value, rounded_ecpm
...
ORDER BY product, ad_format, experiment_group, country, max_unit_id, cnt_type, cnt_value, rounded_ecpm;
