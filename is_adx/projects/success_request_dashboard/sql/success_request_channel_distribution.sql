...
success_request_facts AS (
  SELECT
    ...
    CONCAT(success_network_type, ' / ', success_network) AS success_target
  FROM ranked_success_rows AS success
...
GROUP BY product, ad_format, experiment_group, country, max_unit_id, cnt_type, cnt_value, success_target
...
ORDER BY product, ad_format, experiment_group, country, max_unit_id, cnt_type, cnt_value, success_target;
